...
from HKSdk.pyhikvision.hkws.config import Config
from HKSdk.pyhikvision.hkws.model import base, alarm
...
class BaseAdapter:
    ...
    def activate_device(self, ip="192.168.1.1", port=8000, pwd="123456"):
        ...
        returnInput = base.NET_DVR_ACTIVATECFG()
        returnInput.dwSize = sizeof(returnInput)
