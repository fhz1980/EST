from HKSdk.pyhikvision.hkws.model import camera, callbacks
from HKSdk.pyhikvision.hkws.base_adapter import BaseAdapter
from HKSdk.pyhikvision.hkws.core.type_map import *
...
class CameraAdapter(BaseAdapter):
    ...
    def start_preview(self, cbFunc, channel, userId=0):
        req = camera.NET_DVR_PREVIEWINFO()
        req.hPlayWnd = None
        req.lChannel = channel  # 预览通道号
