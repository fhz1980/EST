...
if __name__ == "__main__":
    wd = getcwd()
    print(wd)
    imgspath = r'D:\belt_person\beltimage'  # imgspath='G:/dataset/VOCdevkit-yolo/VOC2012/JPEGImages'#图片路径
    annpath = r'D:\belt_person\beltxml'  # annpath='G:/dataset/VOCdevkit-yolo/VOC2012/Annotations'#XML路径
    images = r'D:\dataset\belt_person\images'  # 保存路径
    labels = r'D:\dataset\belt_person\labels'  # 保存路径
    classes = ['c1', 'c2', 'c3', 'c4', 'c5', 'person']
